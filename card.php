<?php
    ...
    if (isset($_POST['btn20'])) {
        ...
        $sql = "INSERT INTO `pwebsite`.`payment` (`name`, `email`, `username`, `cardNumber`, `month`, `year`, `cvv`) VALUES ('$name', '$email', '$username', '$cardNumber', '$month', '$year', '$cvv')";

        if (($con->query($sql) == true)) {
            ?>
            <div class="alert alert-success">
                <strong>Successfully Placed Your Order Thankyou</strong>
            </div>
            <?php
        }
        else {           
                        ...
                        <div class="card-header">
                            ...
                            <div class="tab-content">
                                ...
                                <div id="credit-card" class="tab-pane fade show active pt-3">
                                    <form role="form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post"  onsubmit="event.preventDefault()">

                                        <!-- <div class="form-group"> <label for="name">
                                                <h6>Name</h6>
                                            </label> <input type="text" name="name" placeholder="Entered Your Name"
                                        ...
                                        <div class="form-group"> <label for="email">
                                                <h6>Email-Id</h6>
                                            </label> <input type="text" name="email" placeholder="Entered Your Email id"
                                             required class="form-control ">
                                        </div>
                                            ...
                                            <div class="col-sm-8">
                                                <div class="form-group"> <label><span class="hidden-xs">
                                                    ...
                                                    <div class="input-group"> <input type="number" placeholder="MM"
                                                            name="month" class="form-control" required> <input type="number"
                                                            placeholder="YY" name="year" class="form-control" required>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-footer"> <button type="button" name="btn20"
